...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-[var(--color-border)] bg-white shadow-sm text-[var(--color-text)] w-full",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-base sm:text-lg font-medium text-[var(--color-primary)] flex items-center gap-2 truncate",
      className
    )}
    {...props}
  />
