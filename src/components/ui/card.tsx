...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-slate-700/50 bg-slate-800/90 shadow-md text-card-foreground w-full",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-base sm:text-lg font-medium text-indigo-300 flex items-center gap-2 truncate",
      className
    )}
    {...props}
  />
